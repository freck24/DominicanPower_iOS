...
{ public float v = 10;
    ...
    } public void aa2()
    {
        ...
        this.gameObject.GetComponent<SpriteRenderer>().sprite = a2;
    } public void aa3()
    {

        this.gameObject.GetComponent<SpriteRenderer>().sprite = a3;
    } public void aa4()
    {

        this.gameObject.GetComponent<SpriteRenderer>().sprite = a4;
    } 
    ...
    void Update()
    {
        if (subet && yo.transform.position.y<3.21)
        {
            yo.transform.Translate(0, v * Time.deltaTime, 0);
        }
        if (bajat && yo.transform.position.y > -4)
        {
           yo.transform.Translate(0, -v * Time.deltaTime, 0);
        }
    }
